        ...
        <div>
            ...
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogContent>
                        ...
                        <div className="relative w-full">
                            ...
                            <label
                                ...
                                className={`absolute left-2 text-gray-500 transition-all 
                                    ${unitName ? '-top-4 text-sm text-[#6c757d]' : 'top-2 text-base text-gray-400'} 
                    ...
                    <div className="mt-6">
                        <h2 className="text-xl font-bold text-[#483C32] mb-4">Current Units:</h2>
                        {data.length === 0 ? (
                        ...
                        <table className="table-auto w-full border-collapse border border-gray-300">
                            ...
                            {data.map((unit) => (
                                <tr key={unit.unit_id}>
                                <td className="px-4 py-2 border-b text-center">{unit.unit_id}</td>
                                <td className="px-4 py-2 border-b text-center">{unit.unit_name}</td>
