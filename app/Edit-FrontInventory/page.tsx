...
const EditFrontInventory: React.FC<EditFrontInventoryProps> = ({ selectedItem, onClose, onSave }) => {
                    ...
                    <div className="mb-4">
                        ...
                        >
                            {backInventory.map((item: any) => (
                                <option key={item.bd_id} value={item.bd_id}>{item.item_name} (ID: {item.bd_id})</option>
                            ))}
                        </select>
                    </div>
                    <div className="mb-4">
